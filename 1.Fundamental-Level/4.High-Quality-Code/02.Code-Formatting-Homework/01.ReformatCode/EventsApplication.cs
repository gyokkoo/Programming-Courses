namespace _01.ReformatCode
{
    ...
    public class EventsApplication
    {
        ...
        {
            private readonly MultiDictionary<string, Event>
                byTitle = new MultiDictionary<string, Event>(true);

            private readonly OrderedBag<Event>
    ...
    public class Event : IComparable
    {
        ...
        public int CompareTo(object obj)
        {
            ...
            int dateCompareNumber = this.date.CompareTo(other.date);
            int titleCompareNumber = this.title.CompareTo(other.title);
            int locationCompareNumber = this.location.CompareTo(other.location);

            int result;
            if (dateCompareNumber == 0)
            {
                if (titleCompareNumber == 0)
                {
                    result = locationCompareNumber;
                }
                else
                {
                    result = titleCompareNumber;
                }
            }
            else
            {
                result = dateCompareNumber;
            }
