...
namespace _02.LeagueManager
{
    public class LeagueManager
    {
        public static void HandleInput(string input)
        {
            ...
            switch (args[0])
            {
                case "AddTeam": AddTeam(args[1], args[2], DateTime.Parse(args[3])); break;

                case "AddMatch": AddMatch(int.Parse(args[1]), args[2], args[3], int.Parse(args[4]), int.Parse(args[5])); break;

                case "AddPlayerToTeam": AddPlayerToTeam(args[1], args[2], DateTime.Parse(args[3]), decimal.Parse(args[4]), args[5]); break;

                case "ListTeams": ListTeams(); break;
